...
use Uctoo\Wechatopen\Support\XML;
...
class Encryptor
{
    ...
    protected function getAESKey()
    {
        if (empty($this->AESKey)) {
            throw new BaseException("Configuration mission, 'aes_key' is required.");
        }

        if (43 !== strlen($this->AESKey)) {
            throw new BaseException("The length of 'aes_key' must be 43.");
        }
